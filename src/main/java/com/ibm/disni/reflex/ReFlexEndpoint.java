...
*/	
	...
	public synchronized void connect(long ip_addr, int port) throws IOException {
		if (open){
			return;
		}
		nativeDispatcher._connect(ip_addr, port); 
		this.dst_ip_addr = ip_addr;
		this.dst_port = port;
		this.open = true;
	}
